app.service('OligoCalcUtilsService', function () {
    ...
    **  ***/
    ...
    this.CalcIUpair = function (base0, base, i, theSequence, choice) {
        ...
        if (this.IsIUpacBase(base0))	//if previous base is IUpacBase, do nothing
        { return reValue; }
    ...
    this.RemoveNonPrintingChars = function (theString) {
        var returnString = "";
        for (var i = 0; i < theString.length; i++) {
